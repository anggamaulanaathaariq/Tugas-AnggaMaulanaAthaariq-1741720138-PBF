...
class BlogPost extends Component{
    ...
    ambilDataDariServerAPI = () => {                // fungsi untuk mengambil data dari API dengan penambahan sort dan order
        fetch('http://localhost:4000/posts?_sort=id&_order=desc')  // penambahan sort dan order berdasarkan parameter
    ...
    handleHapusArtikel = (data) => {        // fungsi yang meng-handle button action hapus data
        fetch(`http://localhost:4000/posts/${data}`,{method: 'DELETE'})  // alamat URL API yang ingin kita HAPUS datanya
